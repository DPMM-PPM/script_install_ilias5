...
echo "  - Déplacez/copier le répertoire 'data' à  migrer dans /var/www/html/ilias"
echo "  - Copiez le fichier client.ini.php dans /var/www/html/ilias/data/<nom du client>"
echo "  - Copiez le contenu de votre répertoire externe dans /var/www/dataout"
echo "  - Faire un chown -R www-data:www-data sur les répertoires dataout et ilias"
echo "  - Tester via votre navigateur votre application http://<nom de votre server>"
echo "  - Se connecter sur le http://<nom de votre server>/setup/setup.php pour :"
echo "     - vérifier la configuration"
echo "     - modifier mot de passe setup"
echo "     - activer le cache apc du client"
echo ""
